...
class TestOptional:
    def test_optional_int_basemodel_with_default(self) -> None:
    ...
    def test_optional_int_basemodel_without_default(self) -> None:
    ...
    def test_optional_str_basemodel_with_default(self) -> None:
        """Test that an optional int with a default value is set to None when not provided."""
        from typing import Optional  # pylint: disable=import-outside-toplevel

        # GIVEN
        class Model(BaseModel):
            a: Optional[str] = None  # pylint: disable=consider-alternative-union-syntax
    ...
    def test_optional_str_basemodel_without_default(self) -> None:
        """Test that an optional int without a default value is set to None when not provided."""
        from typing import Optional  # pylint: disable=import-outside-toplevel

        # GIVEN
        class Model(BaseModel):
            a: Optional[str]  # pylint: disable=consider-alternative-union-syntax
    ...
    def test_optional_int_parse_df_with_default(self) -> None:
        """Test that an optional int with a default value is set to None when not provided."""
    ...
    def test_optional_int_parse_df_all_none(self) -> None:
        from pandantic import Optional  # pylint: disable=import-outside-toplevel
